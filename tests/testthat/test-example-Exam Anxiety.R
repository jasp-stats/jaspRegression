...
test_that("Correlation results match", {
  ...
  jaspTools::expect_equal_tables(table,
    list(0.396720696926757, 0.220093785299448, 3.3434511480537e-05, 0.548160228665234,
     "-", "jaspColumn1", "jaspColumn2", -0.709249255109869, -0.793816825756736,
     5.1086748506147e-17, -0.597773293353828, "-", "jaspColumn1",
     "jaspColumn3", -0.440993411608789, -0.584624415209784, 3.12787277300792e-06,
