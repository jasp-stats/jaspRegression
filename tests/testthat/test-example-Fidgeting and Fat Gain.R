...
test_that("RegressionLinear (analysis 2) results match", {
  ...
  jaspTools::expect_equal_tables(table,
    list(1, 0.0518472644899151, 4.2, 3.82862269721482, 0.371377302785183,
     ...
     -0.484791407529147, 5, 0.00373716085901112, 3.2, 3.01299026917921,
     ...
     -0.366932392357259, 8, 0.0638650625438182, 1.3, 2.28339501709672,
     ...
     -0.250466613319316, 11, 0.00527024451331423, 1.6, 1.83256021510235,
     ...
     -0.779602995699261, 14, 0.188993278535489, 0.4, 1.50906043351861,
     -1.10906043351861, -1.6052158291364, 15, 0.163585575948666,
