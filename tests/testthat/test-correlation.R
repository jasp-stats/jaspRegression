...
test_that("Bootstrapping results match", {
  ...
  table <- results[["results"]][["mainTable"]][["data"]]
  jaspTools::expect_equal_tables(table,
                                 list(0.111065415602727, 0.00663172434284121, 0.105175421195814, 0.225905499464105,
                                      0.179666477474329, -0.02169083083705, 0.0766902175159553, 0.370571937918771,
                                      "-", 0.195812907755063, 0.00861653015704809, 0.0533190778275557,
                                      0.380632531869915, "contNormal", "contcor1", -0.140516924209084,
                                      -0.310239041677605, 0.0901883731446404, 0.00912193263023227,
                                      -0.152460812916382, -0.404195809764127, 0.214536946611116, 0.0950516392023107,
                                      "-", -0.203777241507667, -0.444584271697389, 0.0955590913846829,
                                      0.0268565605776902, "contNormal", "debMiss30", -0.0439397364731327,
                                      -0.164252411657392, 0.596221799762719, 0.0977122369300128, -0.103189761028142,
                                      -0.302787000917268, 0.402374946397542, 0.110079584950705, "-",
                                      -0.0890439951881228, -0.313429890114458, 0.470233930910906,
                                      0.161445785732352, "contcor1", "debMiss30")
                                 )
})
