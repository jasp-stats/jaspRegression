...
test_that("RegressionLinear (analysis 2) results match", {
  ...
  jaspTools::expect_equal_tables(table,
    list("FALSE", 0.394082222359494, 23.1570553740754, "M<unicode>", "(Intercept)",
     ...
     5.70690457996426e-38, 20.9480892235324, 29.5782471400245, 32.3802720972626,
     "FALSE", 0.158336131923101, -0.968898666442349, "M<unicode>",
     "jaspColumn1", 7.50303223656673e-05, -0.385409058932744, -4.13478438443952,
     -0.654685765768194, -0.340472865094039))
