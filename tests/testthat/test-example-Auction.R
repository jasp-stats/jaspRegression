...
test_that("RegressionLinearBayesian (analysis 2) results match", {
  ...
  jaspTools::expect_equal_tables(table,
    list(1, 372991321.60876, "jaspColumn1 + jaspColumn2", 0.892712653281025,
  ...
  jaspTools::expect_equal_tables(table,
    list(1, "Intercept", 1279.15542238794, 1327.15625, 0, 0, 1, 1, 23.5354308140833,
     1375.15707761205, 254881834333.037, "jaspColumn1", 10.7330040725461,
     12.560696961109, 3.92330612442038e-12, 0.5, 0.999999999996077,
     0.5, 0.896141622303248, 14.388389849672, 186572054.283367, "jaspColumn2",
     66.9998695649713, 84.6326198879855, 5.35985944516426e-09, 0.5,
     0.999999994640141, 0.5, 8.64556708570337, 102.265370211))
