...
* Logistic Regression: the Model Summary table now reports the degrees of freedom of the likelihood ratio test (the change in model fit, `df`) next to ΔΧ², analogous to df1 in Linear Regression. The existing column is relabelled "Residual df".
