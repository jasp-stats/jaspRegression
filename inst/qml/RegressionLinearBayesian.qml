		...
		RadioButtonGroup
		{
			...
			GridLayout
			{
				...
				Group
				{
					...
					RadioButton { value: "hyperGN";			label: qsTr("Hyper-g-n"); info: qsTr("A mixture of g-priors that where u = g/n and u Beta(1, alpha/2) to provide consistency when the null model is true.")	;		id: hypergn			}
				}
				DoubleField
				{
					name: "gPriorAlpha"
