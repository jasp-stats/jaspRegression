...
- Default Model Summary Table (always given)
  ...
  - df: The degrees of freedom of this model comparison, i.e., the difference in the number of estimated parameters between H1 and H0. Report these degrees of freedom (not the residual df) for the comparison of H1 against H0.
