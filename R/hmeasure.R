# function from R package 'hmeasure' (the package got removed from CRAN)
# function relabel is from https://github.com/canagnos/hmeasure/blob/3492f93db543cf9a4814320d5176017489a9f2e1/R/library_aux.R#L2
# all other functions are from https://github.com/canagnos/hmeasure/blob/3492f93db543cf9a4814320d5176017489a9f2e1/R/library_metrics.R#L1
#
# Changes:
#
